...
public:
	...
	// Serialization
	static void _serialize(HDFSFile this_, x10aux::serialization_buffer& buf) {
		assert (false);
	}
	static HDFSFile _deserializer(x10aux::deserialization_buffer& buf) {
		assert (false);
	}
};
...
#endif // __ORG_SCALEGRAPH_IO_HDFSFILE_H
