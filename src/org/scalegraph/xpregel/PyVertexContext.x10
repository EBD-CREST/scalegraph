 ...
 */
public final class PyVertexContext[V, E, M, A] { /*V haszero, E haszero,*/ M haszero, A haszero } implements Iterable[Long] {
	val mWorker :PyWorkerPlaceGraph[V, E];
